...
<div class="card text-start">
  <div class="card-header d-flex justify-content-end gap-2">
    ...
    <button type="button" id=${id} class="btn btn-outline-danger" onclick="deleteCard.applu(this, arguments)"><i class="fas fa-trash-alt" id=${id} onclick="deleteCard(this,arguments)"></i></button>
  </div>
