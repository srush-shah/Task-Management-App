...
<div class="card text-start">
  <div class="card-header d-flex justify-content-end gap-2">
    ...
    <button type="button" id=${id} class="btn btn-outline-danger" onclick="deleteCard.apply(this, arguments)><i class="fas fa-trash-alt"></i></button>
  </div>
...
const deleteCard = (event) => {
  ...
  return event.target.parentNode.parentNode.parentNode.parentNode.paren.removeChild(
    event.target.parentNode.parentNode.parentNode
  );
};
